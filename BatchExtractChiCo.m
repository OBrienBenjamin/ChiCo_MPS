...
% % % % (I.2) identify Adults, Parents, Child
[Laugh] = IdRoles(Laugh);
...
% % % % (I.3-4) remove DC offset, normalize, calcul mps
...
% % % % % (I.5) export to get temporal/spectral modulations (>= 0)
ExportChiCo(Laugh, 'TM_Pos');
ExportChiCo(Laugh, 'SM_Pos');

% % % % (I.6) Calculate Euclidean distances for each Interlocuteur
...
% % % % % (I.7) Export MPS amplitudes from temporal / spectral modulation per interlocuteur type
